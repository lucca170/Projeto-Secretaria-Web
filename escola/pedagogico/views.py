...
class NotaViewSet(viewsets.ModelViewSet):
    ...
    def bulk_update_notas(self, request):
        ...
        for nota_data in notas_data:
            ...
            # Garante que o professor logado é o dono da disciplina
            ...
            try:
                ...
                # Pega o erro de "unique_together" (nota duplicada)
        ...
        if erros:
            # Retorna 207 (Multi-Status) se alguns falharam e outros não
...
def relatorio_desempenho_aluno(request, aluno_id):
    ...
    admin_roles = ['administrador', 'coordenador', 'diretor', 'ti']
    user_cargo = getattr(request.user, 'cargo', None) # Usar getattr para segurança
