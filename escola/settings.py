...
SECRET_KEY = 'django-insecure-m#&a9!^z@_s=r_3j_#t%0#7j@d!+!6j@u%^c7y!s-e_b@d-o5a'
...
REST_AUTH = {
    'USER_DETAILS_SERIALIZER': 'escola.base.serializers.UserDetailsSerializer',
    'TOKEN_SERIALIZER': 'escola.base.serializers.CustomTokenSerializer',
}